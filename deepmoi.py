...
def get_args():
    ...
    parser.add_argument('-n','--omic_name', action='append', help='Input the omics name in the same order as the omics file.', required=True)
    ...
    parser.add_argument('--threshold', help='Threshold to use for FSD screening features,i.e. the proportion of iterations through FSD.', type=float, default=0.8)
    ...
    parser.add_argument('-w','--weight_decay', help='weight_decay parameter for model training.', type=float, default=0.0001)
